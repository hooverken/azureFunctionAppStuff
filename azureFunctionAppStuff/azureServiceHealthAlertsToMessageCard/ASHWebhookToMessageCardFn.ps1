...
# This code was based on a lot of experimentation.  it can probably be mode mroe bulletproof but it is functional
# Use at yhour own risk
...
#
# IMPORTANT:  The uri to send the outgoing webhook (which in my case was for a Teams channel) to needs to
# be set as an environment variable for the function # named "webhookuri".  
