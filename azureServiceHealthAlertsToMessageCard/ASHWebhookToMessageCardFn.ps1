...
#
# CHANGELOG
# 5 May 2022 KH - Dump full JSON payload to generated cared (for debugging, will remove later)
#
...
$SectionsHash.AdSd("activityTitle", ("# " + $payload.data.alertcontext.properties.title))
...
if($null -ne $facts){
    ...
    $sectionsHash.Add("jsonPayload",$request.rawbody)  # for debugging - add full JSON payload to output
}
